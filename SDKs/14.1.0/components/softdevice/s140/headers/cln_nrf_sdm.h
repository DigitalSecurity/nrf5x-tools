...
#define NRF_CLOCK_LF_XTAL_ACCURACY_10_PPM (8)
#define NRF_CLOCK_LF_XTAL_ACCURACY_5_PPM (9)
#define NRF_CLOCK_LF_XTAL_ACCURACY_2_PPM (10)
#define NRF_CLOCK_LF_XTAL_ACCURACY_1_PPM (11)
