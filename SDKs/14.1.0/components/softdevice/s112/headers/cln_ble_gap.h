...
enum BLE_GAP_SVCS
{
  ...
  SD_BLE_GAP_ADDR_GET = BLE_GAP_SVC_BASE + 1,
  SD_BLE_GAP_WHITELIST_SET = BLE_GAP_SVC_BASE + 2,
  SD_BLE_GAP_DEVICE_IDENTITIES_SET = BLE_GAP_SVC_BASE + 3,
  SD_BLE_GAP_PRIVACY_SET = BLE_GAP_SVC_BASE + 4,
  SD_BLE_GAP_PRIVACY_GET = BLE_GAP_SVC_BASE + 5,
  SD_BLE_GAP_ADV_DATA_SET = BLE_GAP_SVC_BASE + 6,
  SD_BLE_GAP_ADV_START = BLE_GAP_SVC_BASE + 7,
  SD_BLE_GAP_ADV_STOP = BLE_GAP_SVC_BASE + 8,
  SD_BLE_GAP_CONN_PARAM_UPDATE = BLE_GAP_SVC_BASE + 9,
  SD_BLE_GAP_DISCONNECT = BLE_GAP_SVC_BASE + 10,
  SD_BLE_GAP_TX_POWER_SET = BLE_GAP_SVC_BASE + 11,
  SD_BLE_GAP_APPEARANCE_SET = BLE_GAP_SVC_BASE + 12,
  SD_BLE_GAP_APPEARANCE_GET = BLE_GAP_SVC_BASE + 13,
  SD_BLE_GAP_PPCP_SET = BLE_GAP_SVC_BASE + 14,
  SD_BLE_GAP_PPCP_GET = BLE_GAP_SVC_BASE + 15,
  SD_BLE_GAP_DEVICE_NAME_SET = BLE_GAP_SVC_BASE + 16,
  SD_BLE_GAP_DEVICE_NAME_GET = BLE_GAP_SVC_BASE + 17,
  SD_BLE_GAP_AUTHENTICATE = BLE_GAP_SVC_BASE + 18,
  SD_BLE_GAP_SEC_PARAMS_REPLY = BLE_GAP_SVC_BASE + 19,
  SD_BLE_GAP_AUTH_KEY_REPLY = BLE_GAP_SVC_BASE + 20,
  SD_BLE_GAP_LESC_DHKEY_REPLY = BLE_GAP_SVC_BASE + 21,
  SD_BLE_GAP_KEYPRESS_NOTIFY = BLE_GAP_SVC_BASE + 22,
  SD_BLE_GAP_LESC_OOB_DATA_GET = BLE_GAP_SVC_BASE + 23,
  SD_BLE_GAP_LESC_OOB_DATA_SET = BLE_GAP_SVC_BASE + 24,
  SD_BLE_GAP_SEC_INFO_REPLY = BLE_GAP_SVC_BASE + 26,
  SD_BLE_GAP_CONN_SEC_GET = BLE_GAP_SVC_BASE + 27,
  SD_BLE_GAP_RSSI_START = BLE_GAP_SVC_BASE + 28,
  SD_BLE_GAP_RSSI_STOP = BLE_GAP_SVC_BASE + 29,
  SD_BLE_GAP_SCAN_START = BLE_GAP_SVC_BASE + 30,
  SD_BLE_GAP_SCAN_STOP = BLE_GAP_SVC_BASE + 31,
  SD_BLE_GAP_RSSI_GET = BLE_GAP_SVC_BASE + 34,
  SD_BLE_GAP_PHY_UPDATE = BLE_GAP_SVC_BASE + 35,
};
enum BLE_GAP_EVTS
{
  BLE_GAP_EVT_CONNECTED = BLE_GAP_EVT_BASE,
  BLE_GAP_EVT_DISCONNECTED = BLE_GAP_EVT_BASE + 1,
  BLE_GAP_EVT_CONN_PARAM_UPDATE = BLE_GAP_EVT_BASE + 2,
  BLE_GAP_EVT_SEC_PARAMS_REQUEST = BLE_GAP_EVT_BASE + 3,
  BLE_GAP_EVT_SEC_INFO_REQUEST = BLE_GAP_EVT_BASE + 4,
  BLE_GAP_EVT_PASSKEY_DISPLAY = BLE_GAP_EVT_BASE + 5,
  BLE_GAP_EVT_KEY_PRESSED = BLE_GAP_EVT_BASE + 6,
  BLE_GAP_EVT_AUTH_KEY_REQUEST = BLE_GAP_EVT_BASE + 7,
  BLE_GAP_EVT_LESC_DHKEY_REQUEST = BLE_GAP_EVT_BASE + 8,
  BLE_GAP_EVT_AUTH_STATUS = BLE_GAP_EVT_BASE + 9,
  BLE_GAP_EVT_CONN_SEC_UPDATE = BLE_GAP_EVT_BASE + 10,
  BLE_GAP_EVT_TIMEOUT = BLE_GAP_EVT_BASE + 11,
  BLE_GAP_EVT_RSSI_CHANGED = BLE_GAP_EVT_BASE + 12,
  BLE_GAP_EVT_ADV_REPORT = BLE_GAP_EVT_BASE + 13,
  BLE_GAP_EVT_SEC_REQUEST = BLE_GAP_EVT_BASE + 14,
  BLE_GAP_EVT_SCAN_REQ_REPORT = BLE_GAP_EVT_BASE + 16,
  BLE_GAP_EVT_PHY_UPDATE_REQUEST = BLE_GAP_EVT_BASE + 17,
  BLE_GAP_EVT_PHY_UPDATE = BLE_GAP_EVT_BASE + 18,
};
enum BLE_GAP_OPTS
{
  BLE_GAP_OPT_CH_MAP = BLE_GAP_OPT_BASE,
  BLE_GAP_OPT_LOCAL_CONN_LATENCY = BLE_GAP_OPT_BASE + 1,
  BLE_GAP_OPT_PASSKEY = BLE_GAP_OPT_BASE + 2,
  BLE_GAP_OPT_SCAN_REQ_REPORT = BLE_GAP_OPT_BASE + 3,
  BLE_GAP_OPT_AUTH_PAYLOAD_TIMEOUT = BLE_GAP_OPT_BASE + 5,
  BLE_GAP_OPT_SLAVE_LATENCY_DISABLE = BLE_GAP_OPT_BASE + 6,
};
enum BLE_GAP_CFGS
{
  BLE_GAP_CFG_ROLE_COUNT = BLE_GAP_CFG_BASE,
  BLE_GAP_CFG_DEVICE_NAME = BLE_GAP_CFG_BASE + 1,
};
